...
#ifndef WIN32_Windows_Win32_WindowsConnectNow_0_H
#define WIN32_Windows_Win32_WindowsConnectNow_0_H
...
{
#pragma region guids
    template <> inline constexpr guid guid_v<Windows::Win32::WindowsConnectNow::IWCNConnectNotify>{ 0xC100BE9F,0xD33A,0x4A4B,{ 0xBF,0x23,0xBB,0xEF,0x46,0x63,0xD0,0x17 } }; // C100BE9F-D33A-4A4B-BF23-BBEF4663D017
    template <> inline constexpr guid guid_v<Windows::Win32::WindowsConnectNow::IWCNDevice>{ 0xC100BE9C,0xD33A,0x4A4B,{ 0xBF,0x23,0xBB,0xEF,0x46,0x63,0xD0,0x17 } }; // C100BE9C-D33A-4A4B-BF23-BBEF4663D017
    template <> inline constexpr guid guid_v<Windows::Win32::WindowsConnectNow::WCNDeviceObject>{ 0xC100BEA7,0xD33A,0x4A4B,{ 0xBF,0x23,0xBB,0xEF,0x46,0x63,0xD0,0x17 } }; // C100BEA7-D33A-4A4B-BF23-BBEF4663D017
