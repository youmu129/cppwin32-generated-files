...
#ifndef WIN32_Windows_Win32_Direct3D10_0_H
#define WIN32_Windows_Win32_Direct3D10_0_H
...
#pragma region delegates
    using PFN_D3D10_CREATE_DEVICE1 = int32_t __stdcall(Windows::Win32::Dxgi::IDXGIAdapter*, Windows::Win32::Direct3D10::D3D10_DRIVER_TYPE, intptr_t, uint32_t, Windows::Win32::Direct3D10::D3D10_FEATURE_LEVEL1, uint32_t, Windows::Win32::Direct3D10::ID3D10Device1**);
    using PFN_D3D10_CREATE_DEVICE_AND_SWAP_CHAIN1 = int32_t __stdcall(Windows::Win32::Dxgi::IDXGIAdapter*, Windows::Win32::Direct3D10::D3D10_DRIVER_TYPE, intptr_t, uint32_t, Windows::Win32::Direct3D10::D3D10_FEATURE_LEVEL1, uint32_t, Windows::Win32::Dxgi::DXGI_SWAP_CHAIN_DESC*, Windows::Win32::Dxgi::IDXGISwapChain**, Windows::Win32::Direct3D10::ID3D10Device1**);
...
{
#pragma region guids
    template <> inline constexpr guid guid_v<Windows::Win32::Direct3D10::ID3D10Asynchronous>{ 0x9B7E4C0D,0x342C,0x4106,{ 0xA1,0x9F,0x4F,0x27,0x04,0xF6,0x89,0xF0 } }; // 9B7E4C0D-342C-4106-A19F-4F2704F689F0
    template <> inline constexpr guid guid_v<Windows::Win32::Direct3D10::ID3D10BlendState>{ 0xEDAD8D19,0x8A35,0x4D6D,{ 0x85,0x66,0x2E,0xA2,0x76,0xCD,0xE1,0x61 } }; // EDAD8D19-8A35-4D6D-8566-2EA276CDE161
    template <> inline constexpr guid guid_v<Windows::Win32::Direct3D10::ID3D10BlendState1>{ 0xEDAD8D99,0x8A35,0x4D6D,{ 0x85,0x66,0x2E,0xA2,0x76,0xCD,0xE1,0x61 } }; // EDAD8D99-8A35-4D6D-8566-2EA276CDE161
    template <> inline constexpr guid guid_v<Windows::Win32::Direct3D10::ID3D10Buffer>{ 0x9B7E4C02,0x342C,0x4106,{ 0xA1,0x9F,0x4F,0x27,0x04,0xF6,0x89,0xF0 } }; // 9B7E4C02-342C-4106-A19F-4F2704F689F0
    template <> inline constexpr guid guid_v<Windows::Win32::Direct3D10::ID3D10Counter>{ 0x9B7E4C11,0x342C,0x4106,{ 0xA1,0x9F,0x4F,0x27,0x04,0xF6,0x89,0xF0 } }; // 9B7E4C11-342C-4106-A19F-4F2704F689F0
    template <> inline constexpr guid guid_v<Windows::Win32::Direct3D10::ID3D10Debug>{ 0x9B7E4E01,0x342C,0x4106,{ 0xA1,0x9F,0x4F,0x27,0x04,0xF6,0x89,0xF0 } }; // 9B7E4E01-342C-4106-A19F-4F2704F689F0
    template <> inline constexpr guid guid_v<Windows::Win32::Direct3D10::ID3D10DepthStencilState>{ 0x2B4B1CC8,0xA4AD,0x41F8,{ 0x83,0x22,0xCA,0x86,0xFC,0x3E,0xC6,0x75 } }; // 2B4B1CC8-A4AD-41F8-8322-CA86FC3EC675
    template <> inline constexpr guid guid_v<Windows::Win32::Direct3D10::ID3D10DepthStencilView>{ 0x9B7E4C09,0x342C,0x4106,{ 0xA1,0x9F,0x4F,0x27,0x04,0xF6,0x89,0xF0 } }; // 9B7E4C09-342C-4106-A19F-4F2704F689F0
    template <> inline constexpr guid guid_v<Windows::Win32::Direct3D10::ID3D10Device>{ 0x9B7E4C0F,0x342C,0x4106,{ 0xA1,0x9F,0x4F,0x27,0x04,0xF6,0x89,0xF0 } }; // 9B7E4C0F-342C-4106-A19F-4F2704F689F0
    template <> inline constexpr guid guid_v<Windows::Win32::Direct3D10::ID3D10Device1>{ 0x9B7E4C8F,0x342C,0x4106,{ 0xA1,0x9F,0x4F,0x27,0x04,0xF6,0x89,0xF0 } }; // 9B7E4C8F-342C-4106-A19F-4F2704F689F0
    template <> inline constexpr guid guid_v<Windows::Win32::Direct3D10::ID3D10DeviceChild>{ 0x9B7E4C00,0x342C,0x4106,{ 0xA1,0x9F,0x4F,0x27,0x04,0xF6,0x89,0xF0 } }; // 9B7E4C00-342C-4106-A19F-4F2704F689F0
    template <> inline constexpr guid guid_v<Windows::Win32::Direct3D10::ID3D10GeometryShader>{ 0x6316BE88,0x54CD,0x4040,{ 0xAB,0x44,0x20,0x46,0x1B,0xC8,0x1F,0x68 } }; // 6316BE88-54CD-4040-AB44-20461BC81F68
    template <> inline constexpr guid guid_v<Windows::Win32::Direct3D10::ID3D10InfoQueue>{ 0x1B940B17,0x2642,0x4D1F,{ 0xAB,0x1F,0xB9,0x9B,0xAD,0x0C,0x39,0x5F } }; // 1B940B17-2642-4D1F-AB1F-B99BAD0C395F
    template <> inline constexpr guid guid_v<Windows::Win32::Direct3D10::ID3D10InputLayout>{ 0x9B7E4C0B,0x342C,0x4106,{ 0xA1,0x9F,0x4F,0x27,0x04,0xF6,0x89,0xF0 } }; // 9B7E4C0B-342C-4106-A19F-4F2704F689F0
    template <> inline constexpr guid guid_v<Windows::Win32::Direct3D10::ID3D10Multithread>{ 0x9B7E4E00,0x342C,0x4106,{ 0xA1,0x9F,0x4F,0x27,0x04,0xF6,0x89,0xF0 } }; // 9B7E4E00-342C-4106-A19F-4F2704F689F0
    template <> inline constexpr guid guid_v<Windows::Win32::Direct3D10::ID3D10PixelShader>{ 0x4968B601,0x9D00,0x4CDE,{ 0x83,0x46,0x8E,0x7F,0x67,0x58,0x19,0xB6 } }; // 4968B601-9D00-4CDE-8346-8E7F675819B6
    template <> inline constexpr guid guid_v<Windows::Win32::Direct3D10::ID3D10Predicate>{ 0x9B7E4C10,0x342C,0x4106,{ 0xA1,0x9F,0x4F,0x27,0x04,0xF6,0x89,0xF0 } }; // 9B7E4C10-342C-4106-A19F-4F2704F689F0
    template <> inline constexpr guid guid_v<Windows::Win32::Direct3D10::ID3D10Query>{ 0x9B7E4C0E,0x342C,0x4106,{ 0xA1,0x9F,0x4F,0x27,0x04,0xF6,0x89,0xF0 } }; // 9B7E4C0E-342C-4106-A19F-4F2704F689F0
    template <> inline constexpr guid guid_v<Windows::Win32::Direct3D10::ID3D10RasterizerState>{ 0xA2A07292,0x89AF,0x4345,{ 0xBE,0x2E,0xC5,0x3D,0x9F,0xBB,0x6E,0x9F } }; // A2A07292-89AF-4345-BE2E-C53D9FBB6E9F
    template <> inline constexpr guid guid_v<Windows::Win32::Direct3D10::ID3D10RenderTargetView>{ 0x9B7E4C08,0x342C,0x4106,{ 0xA1,0x9F,0x4F,0x27,0x04,0xF6,0x89,0xF0 } }; // 9B7E4C08-342C-4106-A19F-4F2704F689F0
    template <> inline constexpr guid guid_v<Windows::Win32::Direct3D10::ID3D10Resource>{ 0x9B7E4C01,0x342C,0x4106,{ 0xA1,0x9F,0x4F,0x27,0x04,0xF6,0x89,0xF0 } }; // 9B7E4C01-342C-4106-A19F-4F2704F689F0
    template <> inline constexpr guid guid_v<Windows::Win32::Direct3D10::ID3D10SamplerState>{ 0x9B7E4C0C,0x342C,0x4106,{ 0xA1,0x9F,0x4F,0x27,0x04,0xF6,0x89,0xF0 } }; // 9B7E4C0C-342C-4106-A19F-4F2704F689F0
    template <> inline constexpr guid guid_v<Windows::Win32::Direct3D10::ID3D10ShaderReflection>{ 0xD40E20B6,0xF8F7,0x42AD,{ 0xAB,0x20,0x4B,0xAF,0x8F,0x15,0xDF,0xAA } }; // D40E20B6-F8F7-42AD-AB20-4BAF8F15DFAA
    template <> inline constexpr guid guid_v<Windows::Win32::Direct3D10::ID3D10ShaderReflectionConstantBuffer>{ 0x66C66A94,0xDDDD,0x4B62,{ 0xA6,0x6A,0xF0,0xDA,0x33,0xC2,0xB4,0xD0 } }; // 66C66A94-DDDD-4B62-A66A-F0DA33C2B4D0
    template <> inline constexpr guid guid_v<Windows::Win32::Direct3D10::ID3D10ShaderReflectionType>{ 0xC530AD7D,0x9B16,0x4395,{ 0xA9,0x79,0xBA,0x2E,0xCF,0xF8,0x3A,0xDD } }; // C530AD7D-9B16-4395-A979-BA2ECFF83ADD
    template <> inline constexpr guid guid_v<Windows::Win32::Direct3D10::ID3D10ShaderReflectionVariable>{ 0x1BF63C95,0x2650,0x405D,{ 0x99,0xC1,0x36,0x36,0xBD,0x1D,0xA0,0xA1 } }; // 1BF63C95-2650-405D-99C1-3636BD1DA0A1
    template <> inline constexpr guid guid_v<Windows::Win32::Direct3D10::ID3D10ShaderResourceView>{ 0x9B7E4C07,0x342C,0x4106,{ 0xA1,0x9F,0x4F,0x27,0x04,0xF6,0x89,0xF0 } }; // 9B7E4C07-342C-4106-A19F-4F2704F689F0
    template <> inline constexpr guid guid_v<Windows::Win32::Direct3D10::ID3D10ShaderResourceView1>{ 0x9B7E4C87,0x342C,0x4106,{ 0xA1,0x9F,0x4F,0x27,0x04,0xF6,0x89,0xF0 } }; // 9B7E4C87-342C-4106-A19F-4F2704F689F0
    template <> inline constexpr guid guid_v<Windows::Win32::Direct3D10::ID3D10SwitchToRef>{ 0x9B7E4E02,0x342C,0x4106,{ 0xA1,0x9F,0x4F,0x27,0x04,0xF6,0x89,0xF0 } }; // 9B7E4E02-342C-4106-A19F-4F2704F689F0
    template <> inline constexpr guid guid_v<Windows::Win32::Direct3D10::ID3D10Texture1D>{ 0x9B7E4C03,0x342C,0x4106,{ 0xA1,0x9F,0x4F,0x27,0x04,0xF6,0x89,0xF0 } }; // 9B7E4C03-342C-4106-A19F-4F2704F689F0
    template <> inline constexpr guid guid_v<Windows::Win32::Direct3D10::ID3D10Texture2D>{ 0x9B7E4C04,0x342C,0x4106,{ 0xA1,0x9F,0x4F,0x27,0x04,0xF6,0x89,0xF0 } }; // 9B7E4C04-342C-4106-A19F-4F2704F689F0
    template <> inline constexpr guid guid_v<Windows::Win32::Direct3D10::ID3D10Texture3D>{ 0x9B7E4C05,0x342C,0x4106,{ 0xA1,0x9F,0x4F,0x27,0x04,0xF6,0x89,0xF0 } }; // 9B7E4C05-342C-4106-A19F-4F2704F689F0
    template <> inline constexpr guid guid_v<Windows::Win32::Direct3D10::ID3D10VertexShader>{ 0x9B7E4C0A,0x342C,0x4106,{ 0xA1,0x9F,0x4F,0x27,0x04,0xF6,0x89,0xF0 } }; // 9B7E4C0A-342C-4106-A19F-4F2704F689F0
    template <> inline constexpr guid guid_v<Windows::Win32::Direct3D10::ID3D10View>{ 0xC902B03F,0x60A7,0x49BA,{ 0x99,0x36,0x2A,0x3A,0xB3,0x7A,0x7E,0x33 } }; // C902B03F-60A7-49BA-9936-2A3AB37A7E33
