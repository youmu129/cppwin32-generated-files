...
#ifndef WIN32_Windows_Win32_Direct3D11_0_H
#define WIN32_Windows_Win32_Direct3D11_0_H
...
#pragma region enums
    ...
    enum class D3D11_BIND_FLAG : int32_t
    {
    ...
    enum class D3D11_CPU_ACCESS_FLAG : int32_t
    {
        D3D11_CPU_ACCESS_WRITE = 65536,
        D3D11_CPU_ACCESS_READ = 131072,
    };
    enum class D3D11_CREATE_DEVICE_FLAG : int32_t
    {
    ...
    enum class D3D11_CRYPTO_SESSION_KEY_EXCHANGE_FLAGS : int32_t
    {
    ...
    enum class D3D11_FENCE_FLAG : int32_t
    {
    ...
    enum class D3D11_RESOURCE_MISC_FLAG : int32_t
    {
    ...
    enum class D3D11_VIDEO_DECODER_HISTOGRAM_COMPONENT_FLAGS : int32_t
    {
...
#pragma region delegates
    ...
    using PFN_D3D11_CREATE_DEVICE = int32_t __stdcall(Windows::Win32::Dxgi::IDXGIAdapter*, Windows::Win32::Direct3D11::D3D_DRIVER_TYPE, intptr_t, uint32_t, Windows::Win32::Direct3D11::D3D_FEATURE_LEVEL*, uint32_t, uint32_t, Windows::Win32::Direct3D11::ID3D11Device**, Windows::Win32::Direct3D11::D3D_FEATURE_LEVEL*, Windows::Win32::Direct3D11::ID3D11DeviceContext**);
    using PFN_D3D11_CREATE_DEVICE_AND_SWAP_CHAIN = int32_t __stdcall(Windows::Win32::Dxgi::IDXGIAdapter*, Windows::Win32::Direct3D11::D3D_DRIVER_TYPE, intptr_t, uint32_t, Windows::Win32::Direct3D11::D3D_FEATURE_LEVEL*, uint32_t, uint32_t, Windows::Win32::Dxgi::DXGI_SWAP_CHAIN_DESC*, Windows::Win32::Dxgi::IDXGISwapChain**, Windows::Win32::Direct3D11::ID3D11Device**, Windows::Win32::Direct3D11::D3D_FEATURE_LEVEL*, Windows::Win32::Direct3D11::ID3D11DeviceContext**);
...
{
#pragma region guids
    template <> inline constexpr guid guid_v<Windows::Win32::Direct3D11::ID3D11Asynchronous>{ 0x4B35D0CD,0x1E15,0x4258,{ 0x9C,0x98,0x1B,0x13,0x33,0xF6,0xDD,0x3B } }; // 4B35D0CD-1E15-4258-9C98-1B1333F6DD3B
    template <> inline constexpr guid guid_v<Windows::Win32::Direct3D11::ID3D11BlendState>{ 0x75B68FAA,0x347D,0x4159,{ 0x8F,0x45,0xA0,0x64,0x0F,0x01,0xCD,0x9A } }; // 75B68FAA-347D-4159-8F45-A0640F01CD9A
    template <> inline constexpr guid guid_v<Windows::Win32::Direct3D11::ID3D11BlendState1>{ 0xCC86FABE,0xDA55,0x401D,{ 0x85,0xE7,0xE3,0xC9,0xDE,0x28,0x77,0xE9 } }; // CC86FABE-DA55-401D-85E7-E3C9DE2877E9
    template <> inline constexpr guid guid_v<Windows::Win32::Direct3D11::ID3D11Buffer>{ 0x48570B85,0xD1EE,0x4FCD,{ 0xA2,0x50,0xEB,0x35,0x07,0x22,0xB0,0x37 } }; // 48570B85-D1EE-4FCD-A250-EB350722B037
    template <> inline constexpr guid guid_v<Windows::Win32::Direct3D11::ID3D11ClassInstance>{ 0xA6CD7FAA,0xB0B7,0x4A2F,{ 0x94,0x36,0x86,0x62,0xA6,0x57,0x97,0xCB } }; // A6CD7FAA-B0B7-4A2F-9436-8662A65797CB
    template <> inline constexpr guid guid_v<Windows::Win32::Direct3D11::ID3D11ClassLinkage>{ 0xDDF57CBA,0x9543,0x46E4,{ 0xA1,0x2B,0xF2,0x07,0xA0,0xFE,0x7F,0xED } }; // DDF57CBA-9543-46E4-A12B-F207A0FE7FED
    template <> inline constexpr guid guid_v<Windows::Win32::Direct3D11::ID3D11CommandList>{ 0xA24BC4D1,0x769E,0x43F7,{ 0x80,0x13,0x98,0xFF,0x56,0x6C,0x18,0xE2 } }; // A24BC4D1-769E-43F7-8013-98FF566C18E2
    template <> inline constexpr guid guid_v<Windows::Win32::Direct3D11::ID3D11ComputeShader>{ 0x4F5B196E,0xC2BD,0x495E,{ 0xBD,0x01,0x1F,0xDE,0xD3,0x8E,0x49,0x69 } }; // 4F5B196E-C2BD-495E-BD01-1FDED38E4969
    template <> inline constexpr guid guid_v<Windows::Win32::Direct3D11::ID3D11Counter>{ 0x6E8C49FB,0xA371,0x4770,{ 0xB4,0x40,0x29,0x08,0x60,0x22,0xB7,0x41 } }; // 6E8C49FB-A371-4770-B440-29086022B741
    template <> inline constexpr guid guid_v<Windows::Win32::Direct3D11::ID3D11Debug>{ 0x79CF2233,0x7536,0x4948,{ 0x9D,0x36,0x1E,0x46,0x92,0xDC,0x57,0x60 } }; // 79CF2233-7536-4948-9D36-1E4692DC5760
    template <> inline constexpr guid guid_v<Windows::Win32::Direct3D11::ID3D11DepthStencilState>{ 0x03823EFB,0x8D8F,0x4E1C,{ 0x9A,0xA2,0xF6,0x4B,0xB2,0xCB,0xFD,0xF1 } }; // 03823EFB-8D8F-4E1C-9AA2-F64BB2CBFDF1
    template <> inline constexpr guid guid_v<Windows::Win32::Direct3D11::ID3D11DepthStencilView>{ 0x9FDAC92A,0x1876,0x48C3,{ 0xAF,0xAD,0x25,0xB9,0x4F,0x84,0xA9,0xB6 } }; // 9FDAC92A-1876-48C3-AFAD-25B94F84A9B6
    template <> inline constexpr guid guid_v<Windows::Win32::Direct3D11::ID3D11Device>{ 0xDB6F6DDB,0xAC77,0x4E88,{ 0x82,0x53,0x81,0x9D,0xF9,0xBB,0xF1,0x40 } }; // DB6F6DDB-AC77-4E88-8253-819DF9BBF140
    template <> inline constexpr guid guid_v<Windows::Win32::Direct3D11::ID3D11Device1>{ 0xA04BFB29,0x08EF,0x43D6,{ 0xA4,0x9C,0xA9,0xBD,0xBD,0xCB,0xE6,0x86 } }; // A04BFB29-08EF-43D6-A49C-A9BDBDCBE686
    template <> inline constexpr guid guid_v<Windows::Win32::Direct3D11::ID3D11Device2>{ 0x9D06DFFA,0xD1E5,0x4D07,{ 0x83,0xA8,0x1B,0xB1,0x23,0xF2,0xF8,0x41 } }; // 9D06DFFA-D1E5-4D07-83A8-1BB123F2F841
    template <> inline constexpr guid guid_v<Windows::Win32::Direct3D11::ID3D11Device3>{ 0xA05C8C37,0xD2C6,0x4732,{ 0xB3,0xA0,0x9C,0xE0,0xB0,0xDC,0x9A,0xE6 } }; // A05C8C37-D2C6-4732-B3A0-9CE0B0DC9AE6
    template <> inline constexpr guid guid_v<Windows::Win32::Direct3D11::ID3D11Device4>{ 0x8992AB71,0x02E6,0x4B8D,{ 0xBA,0x48,0xB0,0x56,0xDC,0xDA,0x42,0xC4 } }; // 8992AB71-02E6-4B8D-BA48-B056DCDA42C4
    template <> inline constexpr guid guid_v<Windows::Win32::Direct3D11::ID3D11Device5>{ 0x8FFDE202,0xA0E7,0x45DF,{ 0x9E,0x01,0xE8,0x37,0x80,0x1B,0x5E,0xA0 } }; // 8FFDE202-A0E7-45DF-9E01-E837801B5EA0
    template <> inline constexpr guid guid_v<Windows::Win32::Direct3D11::ID3D11DeviceChild>{ 0x1841E5C8,0x16B0,0x489B,{ 0xBC,0xC8,0x44,0xCF,0xB0,0xD5,0xDE,0xAE } }; // 1841E5C8-16B0-489B-BCC8-44CFB0D5DEAE
    template <> inline constexpr guid guid_v<Windows::Win32::Direct3D11::ID3D11DeviceContext>{ 0xC0BFA96C,0xE089,0x44FB,{ 0x8E,0xAF,0x26,0xF8,0x79,0x61,0x90,0xDA } }; // C0BFA96C-E089-44FB-8EAF-26F8796190DA
    template <> inline constexpr guid guid_v<Windows::Win32::Direct3D11::ID3D11DeviceContext1>{ 0xBB2C6FAA,0xB5FB,0x4082,{ 0x8E,0x6B,0x38,0x8B,0x8C,0xFA,0x90,0xE1 } }; // BB2C6FAA-B5FB-4082-8E6B-388B8CFA90E1
    template <> inline constexpr guid guid_v<Windows::Win32::Direct3D11::ID3D11DeviceContext2>{ 0x420D5B32,0xB90C,0x4DA4,{ 0xBE,0xF0,0x35,0x9F,0x6A,0x24,0xA8,0x3A } }; // 420D5B32-B90C-4DA4-BEF0-359F6A24A83A
    template <> inline constexpr guid guid_v<Windows::Win32::Direct3D11::ID3D11DeviceContext3>{ 0xB4E3C01D,0xE79E,0x4637,{ 0x91,0xB2,0x51,0x0E,0x9F,0x4C,0x9B,0x8F } }; // B4E3C01D-E79E-4637-91B2-510E9F4C9B8F
    template <> inline constexpr guid guid_v<Windows::Win32::Direct3D11::ID3D11DeviceContext4>{ 0x917600DA,0xF58C,0x4C33,{ 0x98,0xD8,0x3E,0x15,0xB3,0x90,0xFA,0x24 } }; // 917600DA-F58C-4C33-98D8-3E15B390FA24
    template <> inline constexpr guid guid_v<Windows::Win32::Direct3D11::ID3D11DomainShader>{ 0xF582C508,0x0F36,0x490C,{ 0x99,0x77,0x31,0xEE,0xCE,0x26,0x8C,0xFA } }; // F582C508-0F36-490C-9977-31EECE268CFA
    template <> inline constexpr guid guid_v<Windows::Win32::Direct3D11::ID3D11Fence>{ 0xAFFDE9D1,0x1DF7,0x4BB7,{ 0x8A,0x34,0x0F,0x46,0x25,0x1D,0xAB,0x80 } }; // AFFDE9D1-1DF7-4BB7-8A34-0F46251DAB80
    template <> inline constexpr guid guid_v<Windows::Win32::Direct3D11::ID3D11FunctionLinkingGraph>{ 0x54133220,0x1CE8,0x43D3,{ 0x82,0x36,0x98,0x55,0xC5,0xCE,0xEC,0xFF } }; // 54133220-1CE8-43D3-8236-9855C5CEECFF
    template <> inline constexpr guid guid_v<Windows::Win32::Direct3D11::ID3D11FunctionParameterReflection>{ 0x42757488,0x334F,0x47FE,{ 0x98,0x2E,0x1A,0x65,0xD0,0x8C,0xC4,0x62 } }; // 42757488-334F-47FE-982E-1A65D08CC462
    template <> inline constexpr guid guid_v<Windows::Win32::Direct3D11::ID3D11FunctionReflection>{ 0x207BCECB,0xD683,0x4A06,{ 0xA8,0xA3,0x9B,0x14,0x9B,0x9F,0x73,0xA4 } }; // 207BCECB-D683-4A06-A8A3-9B149B9F73A4
    template <> inline constexpr guid guid_v<Windows::Win32::Direct3D11::ID3D11GeometryShader>{ 0x38325B96,0xEFFB,0x4022,{ 0xBA,0x02,0x2E,0x79,0x5B,0x70,0x27,0x5C } }; // 38325B96-EFFB-4022-BA02-2E795B70275C
    template <> inline constexpr guid guid_v<Windows::Win32::Direct3D11::ID3D11HullShader>{ 0x8E5C6061,0x628A,0x4C8E,{ 0x82,0x64,0xBB,0xE4,0x5C,0xB3,0xD5,0xDD } }; // 8E5C6061-628A-4C8E-8264-BBE45CB3D5DD
    template <> inline constexpr guid guid_v<Windows::Win32::Direct3D11::ID3D11InfoQueue>{ 0x6543DBB6,0x1B48,0x42F5,{ 0xAB,0x82,0xE9,0x7E,0xC7,0x43,0x26,0xF6 } }; // 6543DBB6-1B48-42F5-AB82-E97EC74326F6
    template <> inline constexpr guid guid_v<Windows::Win32::Direct3D11::ID3D11InputLayout>{ 0xE4819DDC,0x4CF0,0x4025,{ 0xBD,0x26,0x5D,0xE8,0x2A,0x3E,0x07,0xB7 } }; // E4819DDC-4CF0-4025-BD26-5DE82A3E07B7
    template <> inline constexpr guid guid_v<Windows::Win32::Direct3D11::ID3D11LibraryReflection>{ 0x54384F1B,0x5B3E,0x4BB7,{ 0xAE,0x01,0x60,0xBA,0x30,0x97,0xCB,0xB6 } }; // 54384F1B-5B3E-4BB7-AE01-60BA3097CBB6
    template <> inline constexpr guid guid_v<Windows::Win32::Direct3D11::ID3D11Linker>{ 0x59A6CD0E,0xE10D,0x4C1F,{ 0x88,0xC0,0x63,0xAB,0xA1,0xDA,0xF3,0x0E } }; // 59A6CD0E-E10D-4C1F-88C0-63ABA1DAF30E
    template <> inline constexpr guid guid_v<Windows::Win32::Direct3D11::ID3D11LinkingNode>{ 0xD80DD70C,0x8D2F,0x4751,{ 0x94,0xA1,0x03,0xC7,0x9B,0x35,0x56,0xDB } }; // D80DD70C-8D2F-4751-94A1-03C79B3556DB
    template <> inline constexpr guid guid_v<Windows::Win32::Direct3D11::ID3D11Module>{ 0xCAC701EE,0x80FC,0x4122,{ 0x82,0x42,0x10,0xB3,0x9C,0x8C,0xEC,0x34 } }; // CAC701EE-80FC-4122-8242-10B39C8CEC34
    template <> inline constexpr guid guid_v<Windows::Win32::Direct3D11::ID3D11ModuleInstance>{ 0x469E07F7,0x045A,0x48D5,{ 0xAA,0x12,0x68,0xA4,0x78,0xCD,0xF7,0x5D } }; // 469E07F7-045A-48D5-AA12-68A478CDF75D
    template <> inline constexpr guid guid_v<Windows::Win32::Direct3D11::ID3D11Multithread>{ 0x9B7E4E00,0x342C,0x4106,{ 0xA1,0x9F,0x4F,0x27,0x04,0xF6,0x89,0xF0 } }; // 9B7E4E00-342C-4106-A19F-4F2704F689F0
    template <> inline constexpr guid guid_v<Windows::Win32::Direct3D11::ID3D11PixelShader>{ 0xEA82E40D,0x51DC,0x4F33,{ 0x93,0xD4,0xDB,0x7C,0x91,0x25,0xAE,0x8C } }; // EA82E40D-51DC-4F33-93D4-DB7C9125AE8C
    template <> inline constexpr guid guid_v<Windows::Win32::Direct3D11::ID3D11Predicate>{ 0x9EB576DD,0x9F77,0x4D86,{ 0x81,0xAA,0x8B,0xAB,0x5F,0xE4,0x90,0xE2 } }; // 9EB576DD-9F77-4D86-81AA-8BAB5FE490E2
    template <> inline constexpr guid guid_v<Windows::Win32::Direct3D11::ID3D11Query>{ 0xD6C00747,0x87B7,0x425E,{ 0xB8,0x4D,0x44,0xD1,0x08,0x56,0x0A,0xFD } }; // D6C00747-87B7-425E-B84D-44D108560AFD
    template <> inline constexpr guid guid_v<Windows::Win32::Direct3D11::ID3D11Query1>{ 0x631B4766,0x36DC,0x461D,{ 0x8D,0xB6,0xC4,0x7E,0x13,0xE6,0x09,0x16 } }; // 631B4766-36DC-461D-8DB6-C47E13E60916
    template <> inline constexpr guid guid_v<Windows::Win32::Direct3D11::ID3D11RasterizerState>{ 0x9BB4AB81,0xAB1A,0x4D8F,{ 0xB5,0x06,0xFC,0x04,0x20,0x0B,0x6E,0xE7 } }; // 9BB4AB81-AB1A-4D8F-B506-FC04200B6EE7
    template <> inline constexpr guid guid_v<Windows::Win32::Direct3D11::ID3D11RasterizerState1>{ 0x1217D7A6,0x5039,0x418C,{ 0xB0,0x42,0x9C,0xBE,0x25,0x6A,0xFD,0x6E } }; // 1217D7A6-5039-418C-B042-9CBE256AFD6E
    template <> inline constexpr guid guid_v<Windows::Win32::Direct3D11::ID3D11RasterizerState2>{ 0x6FBD02FB,0x209F,0x46C4,{ 0xB0,0x59,0x2E,0xD1,0x55,0x86,0xA6,0xAC } }; // 6FBD02FB-209F-46C4-B059-2ED15586A6AC
    template <> inline constexpr guid guid_v<Windows::Win32::Direct3D11::ID3D11RefDefaultTrackingOptions>{ 0x03916615,0xC644,0x418C,{ 0x9B,0xF4,0x75,0xDB,0x5B,0xE6,0x3C,0xA0 } }; // 03916615-C644-418C-9BF4-75DB5BE63CA0
    template <> inline constexpr guid guid_v<Windows::Win32::Direct3D11::ID3D11RefTrackingOptions>{ 0x193DACDF,0x0DB2,0x4C05,{ 0xA5,0x5C,0xEF,0x06,0xCA,0xC5,0x6F,0xD9 } }; // 193DACDF-0DB2-4C05-A55C-EF06CAC56FD9
    template <> inline constexpr guid guid_v<Windows::Win32::Direct3D11::ID3D11RenderTargetView>{ 0xDFDBA067,0x0B8D,0x4865,{ 0x87,0x5B,0xD7,0xB4,0x51,0x6C,0xC1,0x64 } }; // DFDBA067-0B8D-4865-875B-D7B4516CC164
    template <> inline constexpr guid guid_v<Windows::Win32::Direct3D11::ID3D11RenderTargetView1>{ 0xFFBE2E23,0xF011,0x418A,{ 0xAC,0x56,0x5C,0xEE,0xD7,0xC5,0xB9,0x4B } }; // FFBE2E23-F011-418A-AC56-5CEED7C5B94B
    template <> inline constexpr guid guid_v<Windows::Win32::Direct3D11::ID3D11Resource>{ 0xDC8E63F3,0xD12B,0x4952,{ 0xB4,0x7B,0x5E,0x45,0x02,0x6A,0x86,0x2D } }; // DC8E63F3-D12B-4952-B47B-5E45026A862D
    template <> inline constexpr guid guid_v<Windows::Win32::Direct3D11::ID3D11SamplerState>{ 0xDA6FEA51,0x564C,0x4487,{ 0x98,0x10,0xF0,0xD0,0xF9,0xB4,0xE3,0xA5 } }; // DA6FEA51-564C-4487-9810-F0D0F9B4E3A5
    template <> inline constexpr guid guid_v<Windows::Win32::Direct3D11::ID3D11ShaderReflection>{ 0x8D536CA1,0x0CCA,0x4956,{ 0xA8,0x37,0x78,0x69,0x63,0x75,0x55,0x84 } }; // 8D536CA1-0CCA-4956-A837-786963755584
    template <> inline constexpr guid guid_v<Windows::Win32::Direct3D11::ID3D11ShaderReflectionConstantBuffer>{ 0xEB62D63D,0x93DD,0x4318,{ 0x8A,0xE8,0xC6,0xF8,0x3A,0xD3,0x71,0xB8 } }; // EB62D63D-93DD-4318-8AE8-C6F83AD371B8
    template <> inline constexpr guid guid_v<Windows::Win32::Direct3D11::ID3D11ShaderReflectionType>{ 0x6E6FFA6A,0x9BAE,0x4613,{ 0xA5,0x1E,0x91,0x65,0x2D,0x50,0x8C,0x21 } }; // 6E6FFA6A-9BAE-4613-A51E-91652D508C21
    template <> inline constexpr guid guid_v<Windows::Win32::Direct3D11::ID3D11ShaderReflectionVariable>{ 0x51F23923,0xF3E5,0x4BD1,{ 0x91,0xCB,0x60,0x61,0x77,0xD8,0xDB,0x4C } }; // 51F23923-F3E5-4BD1-91CB-606177D8DB4C
    template <> inline constexpr guid guid_v<Windows::Win32::Direct3D11::ID3D11ShaderResourceView>{ 0xB0E06FE0,0x8192,0x4E1A,{ 0xB1,0xCA,0x36,0xD7,0x41,0x47,0x10,0xB2 } }; // B0E06FE0-8192-4E1A-B1CA-36D7414710B2
    template <> inline constexpr guid guid_v<Windows::Win32::Direct3D11::ID3D11ShaderResourceView1>{ 0x91308B87,0x9040,0x411D,{ 0x8C,0x67,0xC3,0x92,0x53,0xCE,0x38,0x02 } }; // 91308B87-9040-411D-8C67-C39253CE3802
    template <> inline constexpr guid guid_v<Windows::Win32::Direct3D11::ID3D11ShaderTrace>{ 0x36B013E6,0x2811,0x4845,{ 0xBA,0xA7,0xD6,0x23,0xFE,0x0D,0xF1,0x04 } }; // 36B013E6-2811-4845-BAA7-D623FE0DF104
    template <> inline constexpr guid guid_v<Windows::Win32::Direct3D11::ID3D11ShaderTraceFactory>{ 0x1FBAD429,0x66AB,0x41CC,{ 0x96,0x17,0x66,0x7A,0xC1,0x0E,0x44,0x59 } }; // 1FBAD429-66AB-41CC-9617-667AC10E4459
    template <> inline constexpr guid guid_v<Windows::Win32::Direct3D11::ID3D11SwitchToRef>{ 0x1EF337E3,0x58E7,0x4F83,{ 0xA6,0x92,0xDB,0x22,0x1F,0x5E,0xD4,0x7E } }; // 1EF337E3-58E7-4F83-A692-DB221F5ED47E
    template <> inline constexpr guid guid_v<Windows::Win32::Direct3D11::ID3D11Texture1D>{ 0xF8FB5C27,0xC6B3,0x4F75,{ 0xA4,0xC8,0x43,0x9A,0xF2,0xEF,0x56,0x4C } }; // F8FB5C27-C6B3-4F75-A4C8-439AF2EF564C
    template <> inline constexpr guid guid_v<Windows::Win32::Direct3D11::ID3D11Texture2D>{ 0x6F15AAF2,0xD208,0x4E89,{ 0x9A,0xB4,0x48,0x95,0x35,0xD3,0x4F,0x9C } }; // 6F15AAF2-D208-4E89-9AB4-489535D34F9C
    template <> inline constexpr guid guid_v<Windows::Win32::Direct3D11::ID3D11Texture2D1>{ 0x51218251,0x1E33,0x4617,{ 0x9C,0xCB,0x4D,0x3A,0x43,0x67,0xE7,0xBB } }; // 51218251-1E33-4617-9CCB-4D3A4367E7BB
    template <> inline constexpr guid guid_v<Windows::Win32::Direct3D11::ID3D11Texture3D>{ 0x037E866E,0xF56D,0x4357,{ 0xA8,0xAF,0x9D,0xAB,0xBE,0x6E,0x25,0x0E } }; // 037E866E-F56D-4357-A8AF-9DABBE6E250E
    template <> inline constexpr guid guid_v<Windows::Win32::Direct3D11::ID3D11Texture3D1>{ 0x0C711683,0x2853,0x4846,{ 0x9B,0xB0,0xF3,0xE6,0x06,0x39,0xE4,0x6A } }; // 0C711683-2853-4846-9BB0-F3E60639E46A
    template <> inline constexpr guid guid_v<Windows::Win32::Direct3D11::ID3D11TracingDevice>{ 0x1911C771,0x1587,0x413E,{ 0xA7,0xE0,0xFB,0x26,0xC3,0xDE,0x02,0x68 } }; // 1911C771-1587-413E-A7E0-FB26C3DE0268
    template <> inline constexpr guid guid_v<Windows::Win32::Direct3D11::ID3D11UnorderedAccessView>{ 0x28ACF509,0x7F5C,0x48F6,{ 0x86,0x11,0xF3,0x16,0x01,0x0A,0x63,0x80 } }; // 28ACF509-7F5C-48F6-8611-F316010A6380
    template <> inline constexpr guid guid_v<Windows::Win32::Direct3D11::ID3D11UnorderedAccessView1>{ 0x7B3B6153,0xA886,0x4544,{ 0xAB,0x37,0x65,0x37,0xC8,0x50,0x04,0x03 } }; // 7B3B6153-A886-4544-AB37-6537C8500403
    template <> inline constexpr guid guid_v<Windows::Win32::Direct3D11::ID3D11VertexShader>{ 0x3B301D64,0xD678,0x4289,{ 0x88,0x97,0x22,0xF8,0x92,0x8B,0x72,0xF3 } }; // 3B301D64-D678-4289-8897-22F8928B72F3
    template <> inline constexpr guid guid_v<Windows::Win32::Direct3D11::ID3D11VideoContext3>{ 0xA9E2FAA0,0xCB39,0x418F,{ 0xA0,0xB7,0xD8,0xAA,0xD4,0xDE,0x67,0x2E } }; // A9E2FAA0-CB39-418F-A0B7-D8AAD4DE672E
    template <> inline constexpr guid guid_v<Windows::Win32::Direct3D11::ID3D11VideoDevice2>{ 0x59C0CB01,0x35F0,0x4A70,{ 0x8F,0x67,0x87,0x90,0x5C,0x90,0x6A,0x53 } }; // 59C0CB01-35F0-4A70-8F67-87905C906A53
    template <> inline constexpr guid guid_v<Windows::Win32::Direct3D11::ID3D11View>{ 0x839D1216,0xBB2E,0x412B,{ 0xB7,0xF4,0xA9,0xDB,0xEB,0xE0,0x8E,0xD1 } }; // 839D1216-BB2E-412B-B7F4-A9DBEBE08ED1
    template <> inline constexpr guid guid_v<Windows::Win32::Direct3D11::ID3DBlob>{ 0x8BA5FB08,0x5195,0x40E2,{ 0xAC,0x58,0x0D,0x98,0x9C,0x3A,0x01,0x02 } }; // 8BA5FB08-5195-40E2-AC58-0D989C3A0102
    template <> inline constexpr guid guid_v<Windows::Win32::Direct3D11::ID3DDestructionNotifier>{ 0xA06EB39A,0x50DA,0x425B,{ 0x8C,0x31,0x4E,0xEC,0xD6,0xC2,0x70,0xF3 } }; // A06EB39A-50DA-425B-8C31-4EECD6C270F3
    template <> inline constexpr guid guid_v<Windows::Win32::Direct3D11::ID3DDeviceContextState>{ 0x5C1E0D8A,0x7C23,0x48F9,{ 0x8C,0x59,0xA9,0x29,0x58,0xCE,0xFF,0x11 } }; // 5C1E0D8A-7C23-48F9-8C59-A92958CEFF11
    template <> inline constexpr guid guid_v<Windows::Win32::Direct3D11::ID3DUserDefinedAnnotation>{ 0xB2DAAD8B,0x03D4,0x4DBF,{ 0x95,0xEB,0x32,0xAB,0x4B,0x63,0xD0,0xAB } }; // B2DAAD8B-03D4-4DBF-95EB-32AB4B63D0AB
