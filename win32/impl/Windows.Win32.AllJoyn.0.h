...
#ifndef WIN32_Windows_Win32_AllJoyn_0_H
#define WIN32_Windows_Win32_AllJoyn_0_H
...
#pragma region delegates
    using alljoyn_aboutdatalistener_getaboutdata_ptr = Windows::Win32::AllJoyn::QStatus __stdcall(void*, Windows::Win32::AllJoyn::_alljoyn_msgarg_handle*, int8_t*);
    using alljoyn_aboutdatalistener_getannouncedaboutdata_ptr = Windows::Win32::AllJoyn::QStatus __stdcall(void*, Windows::Win32::AllJoyn::_alljoyn_msgarg_handle*);
    using alljoyn_applicationstatelistener_state_ptr = void __stdcall(int8_t*, int8_t*, Windows::Win32::AllJoyn::alljoyn_applicationstate, void*);
    using alljoyn_keystorelistener_loadrequest_ptr = Windows::Win32::AllJoyn::QStatus __stdcall(void*, Windows::Win32::AllJoyn::_alljoyn_keystorelistener_handle*, Windows::Win32::AllJoyn::_alljoyn_keystore_handle*);
    using alljoyn_keystorelistener_storerequest_ptr = Windows::Win32::AllJoyn::QStatus __stdcall(void*, Windows::Win32::AllJoyn::_alljoyn_keystorelistener_handle*, Windows::Win32::AllJoyn::_alljoyn_keystore_handle*);
    using alljoyn_keystorelistener_acquireexclusivelock_ptr = Windows::Win32::AllJoyn::QStatus __stdcall(void*, Windows::Win32::AllJoyn::_alljoyn_keystorelistener_handle*);
    using alljoyn_keystorelistener_releaseexclusivelock_ptr = void __stdcall(void*, Windows::Win32::AllJoyn::_alljoyn_keystorelistener_handle*);
    using alljoyn_authlistener_requestcredentials_ptr = int32_t __stdcall(void*, int8_t*, int8_t*, uint16_t, int8_t*, uint16_t, Windows::Win32::AllJoyn::_alljoyn_credentials_handle*);
    using alljoyn_authlistener_requestcredentialsasync_ptr = Windows::Win32::AllJoyn::QStatus __stdcall(void*, Windows::Win32::AllJoyn::_alljoyn_authlistener_handle*, int8_t*, int8_t*, uint16_t, int8_t*, uint16_t, void*);
    using alljoyn_authlistener_verifycredentials_ptr = int32_t __stdcall(void*, int8_t*, int8_t*, Windows::Win32::AllJoyn::_alljoyn_credentials_handle*);
    using alljoyn_authlistener_verifycredentialsasync_ptr = Windows::Win32::AllJoyn::QStatus __stdcall(void*, Windows::Win32::AllJoyn::_alljoyn_authlistener_handle*, int8_t*, int8_t*, Windows::Win32::AllJoyn::_alljoyn_credentials_handle*, void*);
    using alljoyn_authlistener_securityviolation_ptr = void __stdcall(void*, Windows::Win32::AllJoyn::QStatus, Windows::Win32::AllJoyn::_alljoyn_message_handle*);
    using alljoyn_authlistener_authenticationcomplete_ptr = void __stdcall(void*, int8_t*, int8_t*, int32_t);
    using alljoyn_buslistener_listener_registered_ptr = void __stdcall(void*, Windows::Win32::AllJoyn::_alljoyn_busattachment_handle*);
    using alljoyn_buslistener_listener_unregistered_ptr = void __stdcall(void*);
    using alljoyn_buslistener_found_advertised_name_ptr = void __stdcall(void*, int8_t*, uint16_t, int8_t*);
    using alljoyn_buslistener_lost_advertised_name_ptr = void __stdcall(void*, int8_t*, uint16_t, int8_t*);
    using alljoyn_buslistener_name_owner_changed_ptr = void __stdcall(void*, int8_t*, int8_t*, int8_t*);
    ...
    using alljoyn_buslistener_bus_prop_changed_ptr = void __stdcall(void*, int8_t*, Windows::Win32::AllJoyn::_alljoyn_msgarg_handle*);
    using alljoyn_interfacedescription_translation_callback_ptr = int8_t* __stdcall(int8_t*, int8_t*, int8_t*);
    using alljoyn_messagereceiver_methodhandler_ptr = void __stdcall(Windows::Win32::AllJoyn::_alljoyn_busobject_handle*, Windows::Win32::AllJoyn::alljoyn_interfacedescription_member*, Windows::Win32::AllJoyn::_alljoyn_message_handle*);
    using alljoyn_messagereceiver_replyhandler_ptr = void __stdcall(Windows::Win32::AllJoyn::_alljoyn_message_handle*, void*);
    using alljoyn_messagereceiver_signalhandler_ptr = void __stdcall(Windows::Win32::AllJoyn::alljoyn_interfacedescription_member*, int8_t*, Windows::Win32::AllJoyn::_alljoyn_message_handle*);
    using alljoyn_busobject_prop_get_ptr = Windows::Win32::AllJoyn::QStatus __stdcall(void*, int8_t*, int8_t*, Windows::Win32::AllJoyn::_alljoyn_msgarg_handle*);
    using alljoyn_busobject_prop_set_ptr = Windows::Win32::AllJoyn::QStatus __stdcall(void*, int8_t*, int8_t*, Windows::Win32::AllJoyn::_alljoyn_msgarg_handle*);
    using alljoyn_busobject_object_registration_ptr = void __stdcall(void*);
    using alljoyn_proxybusobject_listener_introspectcb_ptr = void __stdcall(Windows::Win32::AllJoyn::QStatus, Windows::Win32::AllJoyn::_alljoyn_proxybusobject_handle*, void*);
    using alljoyn_proxybusobject_listener_getpropertycb_ptr = void __stdcall(Windows::Win32::AllJoyn::QStatus, Windows::Win32::AllJoyn::_alljoyn_proxybusobject_handle*, Windows::Win32::AllJoyn::_alljoyn_msgarg_handle*, void*);
    using alljoyn_proxybusobject_listener_getallpropertiescb_ptr = void __stdcall(Windows::Win32::AllJoyn::QStatus, Windows::Win32::AllJoyn::_alljoyn_proxybusobject_handle*, Windows::Win32::AllJoyn::_alljoyn_msgarg_handle*, void*);
    using alljoyn_proxybusobject_listener_setpropertycb_ptr = void __stdcall(Windows::Win32::AllJoyn::QStatus, Windows::Win32::AllJoyn::_alljoyn_proxybusobject_handle*, void*);
    using alljoyn_proxybusobject_listener_propertieschanged_ptr = void __stdcall(Windows::Win32::AllJoyn::_alljoyn_proxybusobject_handle*, int8_t*, Windows::Win32::AllJoyn::_alljoyn_msgarg_handle*, Windows::Win32::AllJoyn::_alljoyn_msgarg_handle*, void*);
    using alljoyn_permissionconfigurationlistener_factoryreset_ptr = Windows::Win32::AllJoyn::QStatus __stdcall(void*);
    ...
    using alljoyn_sessionlistener_sessionlost_ptr = void __stdcall(void*, uint32_t, Windows::Win32::AllJoyn::alljoyn_sessionlostreason);
    using alljoyn_sessionlistener_sessionmemberadded_ptr = void __stdcall(void*, uint32_t, int8_t*);
    using alljoyn_sessionlistener_sessionmemberremoved_ptr = void __stdcall(void*, uint32_t, int8_t*);
    using alljoyn_sessionportlistener_acceptsessionjoiner_ptr = int32_t __stdcall(void*, uint16_t, int8_t*, Windows::Win32::AllJoyn::_alljoyn_sessionopts_handle*);
    using alljoyn_sessionportlistener_sessionjoined_ptr = void __stdcall(void*, uint16_t, uint32_t, int8_t*);
    using alljoyn_about_announced_ptr = void __stdcall(void*, int8_t*, uint16_t, uint16_t, Windows::Win32::AllJoyn::_alljoyn_msgarg_handle*, Windows::Win32::AllJoyn::_alljoyn_msgarg_handle*);
    using alljoyn_busattachment_joinsessioncb_ptr = void __stdcall(Windows::Win32::AllJoyn::QStatus, uint32_t, Windows::Win32::AllJoyn::_alljoyn_sessionopts_handle*, void*);
    using alljoyn_busattachment_setlinktimeoutcb_ptr = void __stdcall(Windows::Win32::AllJoyn::QStatus, uint32_t, void*);
    using alljoyn_autopinger_destination_lost_ptr = void __stdcall(void*, int8_t*, int8_t*);
    using alljoyn_autopinger_destination_found_ptr = void __stdcall(void*, int8_t*, int8_t*);
    using alljoyn_observer_object_discovered_ptr = void __stdcall(void*, Windows::Win32::AllJoyn::_alljoyn_proxybusobject_ref_handle*);
    using alljoyn_observer_object_lost_ptr = void __stdcall(void*, Windows::Win32::AllJoyn::_alljoyn_proxybusobject_ref_handle*);
