...
#ifndef WIN32_Windows_Win32_VirtualStorage_0_H
#define WIN32_Windows_Win32_VirtualStorage_0_H
WIN32_EXPORT namespace win32::Windows::Win32::VirtualStorage
{
#pragma region enums
    enum class APPLY_SNAPSHOT_VHDSET_FLAG : int32_t
    {
    ...
    enum class ATTACH_VIRTUAL_DISK_FLAG : int32_t
    {
    ...
    enum class COMPACT_VIRTUAL_DISK_FLAG : int32_t
    {
    ...
    enum class CREATE_VIRTUAL_DISK_FLAG : int32_t
    {
    ...
    enum class DELETE_SNAPSHOT_VHDSET_FLAG : int32_t
    {
    ...
    enum class DEPENDENT_DISK_FLAG : int32_t
    {
    ...
    enum class DETACH_VIRTUAL_DISK_FLAG : int32_t
    {
        DETACH_VIRTUAL_DISK_FLAG_NONE = 0,
    };
    enum class EXPAND_VIRTUAL_DISK_FLAG : int32_t
    {
    ...
    enum class FORK_VIRTUAL_DISK_FLAG : int32_t
    {
    ...
    enum class GET_STORAGE_DEPENDENCY_FLAG : int32_t
    {
    ...
    enum class MERGE_VIRTUAL_DISK_FLAG : int32_t
    {
    ...
    enum class MIRROR_VIRTUAL_DISK_FLAG : int32_t
    {
    ...
    enum class MODIFY_VHDSET_FLAG : int32_t
    {
    ...
    enum class OPEN_VIRTUAL_DISK_FLAG : int32_t
    {
    ...
    enum class QUERY_CHANGES_VIRTUAL_DISK_FLAG : int32_t
    {
        QUERY_CHANGES_VIRTUAL_DISK_FLAG_NONE = 0,
    };
    enum class RAW_SCSI_VIRTUAL_DISK_FLAG : int32_t
    {
    ...
    enum class RESIZE_VIRTUAL_DISK_FLAG : int32_t
    {
    ...
    enum class TAKE_SNAPSHOT_VHDSET_FLAG : int32_t
    {
    ...
    enum class VIRTUAL_DISK_ACCESS_MASK : int32_t
    {
